...
public class AdminProjectDetailView extends JDialog implements Observer<IModel> {
        ...
        public void displayComponent() {
                ...
                GridBagAdder gridCtr_3 = new GridBagAdder.GridBagAdderBuilder().setY(2).marginT(20).marginB(20)
                                .marginR(20)
        ...
        public void update(Observable<IModel> _observable, IModel model) {
                ...
                if (project != null) {
                        ...
                        studentInput.setText(
                                        project.getStudent() != null ? project.getStudent().getFullName()
                                                        : "No assignee yet");
                        ...
                        if (comments.size() != 0) {
                                ...
                                for (Comment comment : comments) {
                                        ...
                                        Font newTextFieldFont = new Font(time.getFont().getName(),
